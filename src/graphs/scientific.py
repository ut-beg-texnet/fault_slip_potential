...
def save_radial_curves_artifact(
    helper,
    step_index: int,
    radial_df: pd.DataFrame,
    *,
    title: str = "Hydrology Radial Pressure",
):
    """Save the deterministic hydrology radial-pressure chart.

    ``title`` is shown both in the Plotly heading and as the portal artifact title.
    """
